import rexvirtualjoystickplugin from './assets/plugins/rexvirtualjoystickplugin.min.js';
...
export default class Level1 extends Phaser.Scene {
    ...
    setupMobileJoystick() {
        ...
        joystick.on('update', () => {
            const { x, y } = joystick.force;

            if (y < -0.5 && this.player.body.touching.down) {
        ...
        // Fire projectiles with a tap anywhere on the screen
